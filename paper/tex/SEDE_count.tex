...
regenerate from the same computations via \texttt{make\_figures.py}. No
observational data were generated or analysed beyond the standard public
inputs cited in the companion papers.
...
tools (large language models) assisted with drafting and editing the
